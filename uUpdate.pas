...
const
  vPrograma : array [0..19] of String  = ('SSFacil.zip','SSFacil_Parametros.zip','ssCupomFiscal.zip','SSFacil_OS.zip','SSFacil_Prod.zip','SSFacil_MDFe.zip',
                                          ...
                                          'xtrNFeConfig.zip','NFeConfig.zip','AppPedido.zip');
